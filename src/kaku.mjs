...
function createImages(item) {
    ...
    imgHtml = `${caption ? `<figure>` : ''}<picture><source type="image/webp" data-srcset="${imgUrl}-240.webp 300w, ${imgUrl}-680.webp 600w, ${imgUrl}-900.webp 900w, ${imgUrl}.webp 1200w" /><img loading="lazy" ${alt ? ` data-${alt}`: ""} data-srcset="${imgUrl}-240.jpg 300w, ${imgUrl}-680.jpg 600w, ${imgUrl}-900.jpg 900w, ${imgUrl}.jpg 1200w" data-src="${imgUrl}.jpg"></picture>${caption} ${caption ? `</figure>` : ''}<noscript> ${caption ? `<figure>` : ''} <picture> <source type="image/webp" srcset="${imgUrl}-240.webp 300w, ${imgUrl}-680.webp 600w, ${imgUrl}-900.webp 900w, ${imgUrl}.webp 1200w" /> <img loading="lazy" ${alt ? ` ${alt}`: ""} srcset="${imgUrl}-240.jpg 300w, ${imgUrl}-680.jpg 600w, ${imgUrl}-900.jpg 900w, ${imgUrl}.jpg 1200w" src="${imgUrl}.jpg"> </picture> ${caption} ${caption ? `</figure>` : ''} </noscript>`
    return imgHtml
}
